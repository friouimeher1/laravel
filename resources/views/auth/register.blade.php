                ...
                <div class="panel-body">
                      ...
                      <div class="form-group{{ $errors->has('ville') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group{{ $errors->has('compte') ? ' has-error' : '' }}">
                            <label for="prenom" class="col-md-4 control-label">Compte</label>

                            <div class="col-md-6">
                                <input id="compte" type="compte" class="form-control" name="compte" value="{{ old('compte') }}">

                                @if ($errors->has('compte'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('compte') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
